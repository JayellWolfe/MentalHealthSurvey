...
navbar = dbc.NavbarSimple(
    brand='Mental Health Disorders in the Tech Workplace',
    brand_href='/', 
    children=[
        ...
        dbc.Col(
            html.P(
                [
                    ...
                    html.A(html.I(className='fas fa-envelope-square mr-1'), href='mailto:<jayellwolfe@gmail.com>.com'), 
                    html.A(html.I(className='fab fa-github-square mr-1'), href='https://github.com/<jayellwolfe/MentalHealthSurvey>/<repo>'), 
